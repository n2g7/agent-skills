---
name: create-plugin
description: Guides end-to-end Claude Code plugin creation through discovery, component design, implementation, validation, and documentation. Use when the user asks to create a plugin, scaffold a plugin, or run a plugin creation workflow.
disable-model-invocation: true
---

Source: Anthropic plugin-dev (https://github.com/anthropics/claude-code/tree/main/plugins/plugin-dev), converted to a skill.

Original Claude Code metadata: argument-hint `Optional plugin description`; allowed-tools `Read`, `Write`, `Grep`, `Glob`, `Bash`, `TodoWrite`, `AskUserQuestion`, `Skill`, `Task`.
...
- **Load relevant skills**: Read and follow the relevant skill's SKILL.md when needed (`plugin-structure`, `hook-development`, `agent-development`, etc.)
- **Use specialized agents**: Leverage the `plugin-dev-agent-creator`, `plugin-validator`, and `skill-reviewer` skills for AI-assisted development
- **Follow best practices**: Apply patterns from plugin-dev's own implementation
- **Progressive disclosure**: Create lean skills with references/examples
- **Use TodoWrite**: Track all progress throughout all phases

**Initial request:** the user's plugin description
...
**MUST load the `plugin-structure` skill** (read `plugin-structure/SKILL.md`) before this phase.

**Actions**:
1. Read and follow the `plugin-structure` skill to understand component types
...
- Skills: Read and follow the `skill-development` skill
- Commands: Read and follow the `command-development` skill
- Agents: Read and follow the `agent-development` skill
- Hooks: Read and follow the `hook-development` skill
- MCP: Read and follow the `mcp-integration` skill
- Settings: Read and follow the `plugin-settings` skill

**Actions for each component**:

### For Skills:
1. Read and follow the `skill-development` skill
2. For each skill:
...
3. Use the `skill-reviewer` skill to validate each skill

### For Commands:
1. Read and follow the `command-development` skill
2. For each command:
...
### For Agents:
1. Read and follow the `agent-development` skill
2. For each agent, use the `plugin-dev-agent-creator` skill:
...
### For Hooks:
1. Read and follow the `hook-development` skill
2. For each hook:
...
### For MCP:
1. Read and follow the `mcp-integration` skill
...
### For Settings:
1. Read and follow the `plugin-settings` skill
...
**Actions**:
1. **Run the `plugin-validator` skill**:
   - Use the `plugin-validator` skill to comprehensively validate plugin
...
3. **Review with skill-reviewer** (if plugin has skills):
   - For each skill, use the `skill-reviewer` skill
...
- **Read and follow the relevant skill's SKILL.md** when working on specific component types
- **Use specialized skills** (`plugin-dev-agent-creator`, `plugin-validator`, `skill-reviewer`)
