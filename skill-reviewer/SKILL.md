---
name: skill-reviewer
description: Reviews Claude Code skill quality, including description triggers, progressive disclosure, and writing style. Use when the user asks to review a skill, check skill quality, improve a skill description, or after creating or modifying a skill.
...
Original Claude Code metadata: model `inherit`, color `cyan`, tools `Read`, `Grep`, `Glob`.
